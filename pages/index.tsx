            ...
            <code className={styles.code}>
              ...
              <p>{"}"}</p> */
                <p className='p-3 index_code__ETUOL>p'>
                  I am Kamal Hossen, I am a web Designer and Developer, I have Completed Diploma in Engineering From Jhenaidah Polytechnic Institute, Now I have Running Bsc in Engineering in CSE at Bangladesh University of Business and Technology, I worked at Aman Knitting Ltd as a Store Officer, Now I Working Trust Technical Training Institute
